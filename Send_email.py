...
sender_email = 'jonydhgt@gmail.com' # your Gmail email address
password_email = 'gjua tcjd hcqp pqmw'  # your Gmail password or App Password

def send_email(subject, receiver_email, name, due_date, invoice_no, amount):
    # Create the base text message.
    msg = EmailMessage()
    msg["Subject"] = subject
    msg["From"] = formataddr(("Jony Dasari.", f"{sender_email}"))
